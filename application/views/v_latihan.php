<section id="hero" class="hero d-flex align-items-center"> 
      <div class="container">
        <div class="row justify-content-between gy-0 mt-5">
          <div class="col-lg-5  d-flex flex-column justify-content-center mt-5 ">
            <h2 style="text-indent: 35px;"data-aos="fade-right" data-aos-duration="2000">Website Toko Penjualan Sparepart Motor dan Mobil
             </h2>
